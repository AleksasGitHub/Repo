...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.startButton.resize(200, 32)
        self.startButton.setGeometry(0, 660, 150, 32)
        ...
        self.tournamentButton.resize(200, 32)
        self.tournamentButton.setGeometry(300, 660, 150, 32)
        ...
        self.exitButton.resize(200, 32)
        self.exitButton.setGeometry(450, 660, 150, 32)
        ...
        self.continueButton.resize(130, 32)
    ...
    def showHideWdigets(self):
        ...
        self.hbox.addWidget(self.startButton, 8, 1)
        self.startButton.show()
        self.hbox.addWidget(self.onlineButton, 8, 2)
        self.onlineButton.show()
        self.hbox.addWidget(self.tournamentButton, 8, 3)
        self.tournamentButton.show()
        self.hbox.addWidget(self.exitButton, 8, 4)
        self.exitButton.show()
        ...
        if self.tournament:
            ...
            if(self.tournamentCount == 5):
                ...
                if (self.mover1TournamentResult > self.mover2TournamentResult):
                    self.scoreTournamentEndLabel.setText("PLAYER 1 WON THE TOURNAMENT")
                elif (self.mover1TournamentResult < self.mover2TournamentResult):
                    self.scoreTournamentEndLabel.setText("PLAYER 2 WON THE TOURNAMENT")
                else:
